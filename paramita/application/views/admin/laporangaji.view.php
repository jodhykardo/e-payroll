...
<?php
   create_table(array("Nama Perusahaan", "Nama Karyawan", "Total Gaji", "Total Potongan", "Bonus", "Gaji Yang Diterima"));
end_content();
...
$(function(){
   ...
   //Menerapkan plugin dataTable dengan tambahan tombol ekspor
      table = $('.table').DataTable({
        ...
        "processing" : true,
        "ajax" : {
          "url" : "<?= BASE_PATH ?>/admin/laporangaji/listData/"+mulai+"_"+sampai,
          "type" : "POST"
        }
      });
   ...
   $('#form-laporan').submit(function(){
      ...
      table.ajax.url("<?= BASE_PATH ?>/admin/laporangaji/listData/"+mulai+"_"+sampai);
      table.buttons();
      table.ajax.reload();
      return false;
    });
