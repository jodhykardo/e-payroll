...
<div class="row">
<?php
   create_panel("teal", "th-large", $data['karyawan'], "Jumlah Karyawan");
   create_panel("blue", "gift", $data['sakit'], "Jumlah Sakit");
   create_panel("orange", "shopping-cart", $data['izin'], "Jumlah Izin");
   create_panel("red", "envelope", $data['cuti'], "Jumlah Cuti");
?>
</div>
<?php
   start_content();
